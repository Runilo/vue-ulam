      ...
      <form id="ulam-controls" name="ulam-controls">
        <div class="group">
          <div class="start form-group">
            ...
            <input class="form-control form-control" type="number" id="start" name="start" v-model.number="start">
          </div>

          <div class="length form-group">
            <label for="length">Length</label>

            <input class="form-control form-control" type="number" id="length" name="length" v-model.number="length">
          </div>
        </div>
        ...
        <div class="group">
          <div class="start-direction form-group">
            ...
            <select class="form-control form-control" name="start-direction" id="start-direction" v-model="startDirection">
          ...
          <div class="rotation-direction form-group">
            ...
            <select class="form-control form-control-lg" name="rotation-direction" id="rotation-direction" v-model="rotationDirection">
